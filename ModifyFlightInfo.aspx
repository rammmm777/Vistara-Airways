<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyFlightInfo.aspx.cs" Inherits="AIRLINES_PROJECT.ModifyFlightInfo" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title>Modify Flight’s Information</title>
    <style>
        body {
...
<a href="Login.aspx">SignOut</a>
        ...
        <div class="container">
            <h2>Modify Flight’s Information</h2>

            <div class="form-section">
                <label>Select Flight Code:</label>
                <asp:DropDownList ID="ddlFlightCode" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFlightCode_SelectedIndexChanged" ></asp:DropDownList>
            </div>
            ...
            <div class="form-section">
                ...
                <asp:TextBox ID="txtArrival" runat="server" placeholder="HH:MM" />
            </div>

            <div class="form-section">
                <label>Departure Time:</label>
                <asp:TextBox ID="txtDeparture" runat="server" placeholder="HH:MM" />
            </div>
